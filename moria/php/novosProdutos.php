...
$sql = "SELECT p.pro_cod, p.pro_nome, p.pro_preco, p.pro_descricao, f.fot_url, fa.fab_nome, fa.fab_cod
		...
		WHERE p.pro_cod = pf.pro_cod AND f.fot_cod = pf.fot_cod AND pf.pro_fot_principal = 'S' AND fa.fab_cod = p.fab_cod
...
$template->setCurrentBlock("bloco_busca");
	...
	/* Titulos */
		$template->setVariable("tituloBusca", "Novos Produtos:");
