...
/* $Id: config.default.php,v 2.18 2005/11/02 19:46:47 nijel Exp $ */
...
$i++;
$cfg['Servers'][$i]['host']          = '172.26.6.6'; // MySQL hostname or IP address
...
$cfg['Servers'][$i]['user']          = 'pos';      // MySQL user
$cfg['Servers'][$i]['password']      = 'pos123';          // MySQL password (only needed
                                                    // with 'config' auth_type)
$cfg['Servers'][$i]['only_db']       = 'sitepos';          // If set to a db-name, only
