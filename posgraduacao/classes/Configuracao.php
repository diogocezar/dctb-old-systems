...
* Origem do email.
*/
define(ORIGEM, 'assinfdsv-cp@utfpr.edu.br');

/**
* Empresa/Autor do email.
*/
define(AUTOR, 'DEPOG - PosGraduaчуo UTF-PR');

/**
* Mensagem final.
*/
define(MSG_FINAL, 'Por favor nуo responda essa mensagem, ela foi gerada automсticamente por nosso sistema. <br> Atenciosamente');
...
/**
* Path padrуo para armazenamento das cookies.
*/
define(PATH_COOKIE, '/');
