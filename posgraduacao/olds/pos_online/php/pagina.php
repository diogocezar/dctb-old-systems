...
$template->setCurrentBlock("bloco_turma_anterior");
	if($id == 5){
		$template->setVariable("turmaAnterior", "<img src=\"../images/seta_preta.gif\" border=\"0\" />&nbsp;<a href=\"pagina.php?id=10\" class=\"link_escuro\">Turma 2006");
	}
	if($id == 10){
		$template->setVariable("turmaAnterior", "<img src=\"../images/seta_preta.gif\" border=\"0\" />&nbsp;<a href=\"pagina.php?id=5\" class=\"link_escuro\">Turma 2007");
	}
