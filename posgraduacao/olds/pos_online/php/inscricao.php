...
switch($acao){
	...
	case 'atualizar' :
		if($_SESSION['permitido'] == 'sim'){
			...
			$inscricao['graduacao']     = $dados['ins_graduacao'];
...
$template->setCurrentBlock("bloco_form_inscricao");
	...
	/* Titulos dos Campos */	
		...
		$template->setVariable("graduacao", "Graduação");
	...
	/* Nomes dos Campos */
		...
		$template->setVariable("campoGraduacao", "graduacao");
	...
	/* Java Script ao Enviar */
		$template->setVariable("onClickEnviar", "validaInscricao(formInscri.nome, formInscri.cpf, formInscri.rg, formInscri.emissor, formInscri.data_nascimento, formInscri.graduacao, formInscri.rua, formInscri.numero, formInscri.bairro, formInscri.cidade, formInscri.cep, formInscri.telefone, formInscri.email, formInscri)");
