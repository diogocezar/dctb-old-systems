...
switch($op){
	...
	case 'inscricao' :
		...
		$sql = "SELECT max(ins_cod) as maxIns FROM {$tabela['inscricoes']}";
		$resultado = $dataBase->query($sql);
		$dados = $resultado->fetchRow(DB_FETCHMODE_ASSOC);
		$numInscri = $dados['maxIns'];
...
$msg .= "<div align=\"center\">";
$msg .= "<br><br>";
$msg .= "Para concluir sua inscrição, clique no botão para gerar a impressão.";
$msg .= "<br><br>";
$msg .= "<input name=\"btnInscricao\" type=\"button\" class=\"botao\" id=\"btnInscricao\" value=\"Imprimir Inscrição\" onclick=\"javascript:window.open('printInscricao.php?ni=$numInscri')\">";
$msg .= "</div>";
}
