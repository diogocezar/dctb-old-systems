...
$template->setCurrentBlock("bloco_html");
	...
	$onLoad .= "onLoad = \"";
	$onLoad .= "call_getFiltredRegistersManifesto(true, event);";
	...
	$template->setVariable("cmp_form_key_press", "call_getFiltredRegistersManifesto(false, event)");
	...
	if(is_array($campos)){
		...
		$template->setVariable("cmp_campos_procura", 'data, codigo, fornecedor, status');
	}
	else{
