...
class Manifesto extends Body{
	...
	*/  
	...
	/** 
	* Mщtodo retorna uma lista de Embalagens e a indexaчуo de seu id
	* @access public
	*/  	
	function _list(){
		global $tabelaMap;
		...
		$sql .= "SELECT ".$this->campos[3].", ".$this->campos[0]." FROM ";
		$sql .= $this->getTabela();
		$sql .= " WHERE ".$this->campos[14]." = 'TRUE'";
		$sql .= " ORDER BY ".$this->campos[3]." DESC";
