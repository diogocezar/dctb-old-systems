...
* call_deleteRegister(key);
*/
function call_devolverLoc(key){
	var vDevolver = confirm("Deseja devolver essa locação?");
	if(vDevolver){
		x_devolverLoc(key, return_devolverLoc);
	}
}

function return_devolverLoc(retorno){
