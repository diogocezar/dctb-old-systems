...
<table width="763" height="768" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
  ...
  <tr>
    ...
    <td colspan="6" rowspan="10" valign="top" bgcolor="eff6ee"><div align="center">
      <p class="style13"><br>
        <span class="style11"><img src="images/bolinha.gif" width="6" height="6"> </span><strong><strong><strong>Alterar Administrador</strong></strong></strong></p>
	<?php
	  	$id = $_GET['id'];

		$query = $MySQL->Query("SELECT * FROM {$tabela['admin']} WHERE {$camposTab2[0]} = $id");
		$data = mysql_fetch_array($query);
		
		$nome     = $data[$camposTab2[1]];
		$email    = $data[$camposTab2[2]];
		$login    = $data[$camposTab2[3]];
		$senha    = $data[$camposTab2[4]];
			  
	  ?>
      <form name="form_admin" method="post" action="alterar.php?tipo=admin&id=<?=$id?>">
        <table width="400" border="0">
          <!--DWLayoutTable-->
          <tr>
            <td width="143" valign="middle" class="style11"><div align="right"><img src="images/bolinha.gif" width="6" height="6"> Nome </div></td>
            <td width="247"><input name="adm_nome" type="text" class="caixa" id="adm_nome" size="45" value="<?= $nome ?>"></td>
          </tr>
          <tr>
            <td height="21" valign="middle" class="style11"><div align="right"><img src="images/bolinha.gif" width="6" height="6"> E-mail </div></td>
            <td valign="top"><input name="adm_email" type="text" class="caixa" id="adm_email" size="45" value="<?= $email?>"></td>
          </tr>
          <tr>
            <td height="21" valign="middle" class="style11"><div align="right"><img src="images/bolinha.gif" width="6" height="6"> Login </div></td>
            <td valign="top"><input name="adm_login" type="text" class="caixa" id="adm_login" size="45" value="<?= $login?>"></td>
          </tr>
          <tr>
            <td height="21" valign="middle" class="style11"><div align="right"><img src="images/bolinha.gif" width="6" height="6"> Senha </div></td>
            <td valign="top"><input name="adm_senha" type="password" class="caixa" id="adm_senha" size="45" value="<?= $senha?>"></td>
          </tr>
          <tr>
            <td height="13"></td>
            <td></td>
          ...
          <tr>
            ...
            <td align="center" valign="middle">
                ...
                <div align="center">
                  <input name="Enviar" type="button" class="caixa" id="Enviar" value="Enviar" onClick="validaAdminAtu(document.form_admin.adm_nome, document.form_admin.adm_email, document.form_admin.adm_login, document.form_admin.adm_senha, document.form_admin)">
                &nbsp;</div></td>
          </tr>
          <tr>
            <td height="6"></td>
