...
<table width="763" height="768" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
  ...
  <tr>
    ...
    <td colspan="6" rowspan="10" valign="top" bgcolor="eff6ee"><div align="center">
      <p class="style13"><br>
        <span class="style11"><img src="images/bolinha.gif" width="6" height="6"> </span><strong><strong><strong>Adicionar Administrador</strong></strong></strong></p>
      <form name="form_admin" method="post" action="adicionar.php?tipo=admin">
        <table width="400" border="0">
          <!--DWLayoutTable-->
          <tr>
            <td width="143" valign="middle" class="style11"><div align="right"><img src="images/bolinha.gif" width="6" height="6"> Nome </div></td>
            <td width="247"><input name="adm_nome" type="text" class="caixa" id="adm_nome" size="45"></td>
          </tr>
          <tr>
            <td height="21" valign="middle" class="style11"><div align="right"><img src="images/bolinha.gif" width="6" height="6"> E-mail </div></td>
            <td valign="top"><input name="adm_email" type="text" class="caixa" id="adm_email" size="45"></td>
          </tr>
          <tr>
            <td height="21" valign="middle" class="style11"><div align="right"><img src="images/bolinha.gif" width="6" height="6"> Login </div></td>
            <td valign="top"><input name="adm_login" type="text" class="caixa" id="adm_login" size="45"></td>
          </tr>
          <tr>
            <td height="21" valign="middle" class="style11"><div align="right"><img src="images/bolinha.gif" width="6" height="6"> Senha </div></td>
            <td valign="top"><input name="adm_senha" type="password" class="caixa" id="adm_senha" size="45"></td>
          </tr>
          <tr>
            <td height="21" valign="middle" class="style11"><div align="right"><img src="images/bolinha.gif" width="6" height="6"> Confirmar Senha </div></td>
            <td valign="top"><input name="adm_senha_conf" type="password" class="caixa" id="adm_senha_conf" size="45"></td>
          </tr>
          <tr>
            <td height="16"></td>
            <td></td>
          ...
          <tr>
            ...
            <td align="center" valign="middle">
                ...
                <div align="center">
                  <input name="Enviar" type="button" class="caixa" id="Enviar" value="Enviar" onClick="validaAdmin(document.form_admin.adm_nome, document.form_admin.adm_email, document.form_admin.adm_login, document.form_admin.adm_senha, document.form_admin.adm_senha_conf, document.form_admin)">
                  &nbsp;
                  <input name="Limpar" type="reset" class="caixa" id="Limpar" value="Limpar">
              </div></td>
          </tr>
          <tr>
            <td height="16"></td>
      ...
      <p align="center" class="style14"><span class="style13"><span class="style13">
        <img src="images/bolinha.gif" width="6" height="6"> <strong>Gerenciar Administradores</strong></span><span class="style11"><strong><br>
	    </strong> </span>
      <br>
	  <?php
	  	
			$query = $MySQL->Query("SELECT * FROM {$tabela['admin']} ORDER BY {$camposTab2[1]}");
			while($data = mysql_fetch_array($query)){
			echo "
			<table width=\"450\" border=\"0\" bordercolor=\"#4C7149\">
			<tr bgcolor=\"#FFFFFF\">
			  <td colspan=\"3\" bordercolor=\"#40683D\"><font color=\"40683d\" size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\"><strong><img src=\"images/bolinha.gif\" width=\"6\" height=\"6\"> {$data[$camposTab2[1]]}</strong></font></td>
			  </tr>
			<tr>
			  <td width=\"312\" bordercolor=\"#40683D\">&nbsp;</td>
			  <td width=\"63\" class=\"style11\"><font color=\"40683d\" size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\"><strong><img src=\"images/bolinha.gif\" width=\"6\" height=\"6\"> </strong></font><a href=\"excluir.php?tipo=admin&id={$data[$camposTab2[0]]}\">Excluir</a></td>
			  <td width=\"61\" class=\"style11\"><font color=\"40683d\" size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\"><strong><img src=\"images/bolinha.gif\" width=\"6\" height=\"6\"> </strong></font><a href=\"frm_alt_adm.php?id={$data[$camposTab2[0]]}\">Alterar</a></td>
			</tr>
		  </table>";
			}  
	  ?>
      ...
      <p align="left">
        <input name="Voltar" type="button" class="caixa" id="Enviar2" value="&laquo;&laquo; Voltar" onClick="location.href='admin.php'"></p></td>
