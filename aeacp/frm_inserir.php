...
<table width="763" height="768" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
  ...
  <tr>
    ...
    <td colspan="6" rowspan="10" valign="top" bgcolor="eff6ee"><div align="center">
      <p class="style13"><br>
        <span class="style11"><img src="images/bolinha.gif" width="6" height="6"> </span>        Inserir Not&iacute;cias </p>
      <form name="form_noti" method="post" action="adicionar.php?tipo=noticia">
        <table width="400" border="0">
          <!--DWLayoutTable-->
          <tr>
            <td width="142" class="style11"><div align="right"><img src="images/bolinha.gif" width="6" height="6"> Titulo </div></td>
            <td width="242"><input name="not_titulo" type="text" class="caixa" id="not_titulo" size="45"></td>
            <td width="2"></td>
          </tr>
          <tr>
            <td class="style11"><div align="right"><img src="images/bolinha.gif" width="6" height="6"> Fonte </div></td>
            <td><input name="not_fonte" type="text" class="caixa" id="not_fonte" size="45"></td>
            <td></td>
          </tr>
          <tr>
            ...
            <td valign="top"><textarea name="not_descricao" cols="44" rows="7" class="caixa" id="not_descricao"></textarea></td>
            <td></td>
          </tr>
