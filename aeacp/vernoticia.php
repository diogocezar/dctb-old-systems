...
<table width="763" height="656" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
  <!--DWLayoutTable-->
  <tr> 
  ...
  <tr>
    ...
    <td colspan="8" valign="top"><img src="images/top_noticiasinterna.gif" width="534" height="24"></td>
      ...
      <table width="90%" border="0" align="center">
        <tr>
          <td><p>
            ...
            <p><font color="#336633" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong><img src="images/seta.gif" width="7" height="6"> <a href="vertodas.php">Todas Not&iacute;cias Anteriores </a><br>
            </strong></font></p></td>
        </tr>
      </table></td>
    <td width="13" rowspan="10" valign="top" bgcolor="eff6ee"><!--DWLayoutEmptyCell-->&nbsp;</td>
    <td colspan="6" rowspan="10" valign="top" bgcolor="eff6ee"><br>
	<div align="justify">
	<?
					
					
					$query = $MySQL->Query("SELECT * FROM {$tabela['noticias']} WHERE {$camposTab1[0]} = $id_get");
					...
					echo "<img src=\"images/bolinha.gif\" width=\"6\" height=\"6\">";
					echo "<strong> $titulo</strong>";
					echo "<br><br>";
					if(!empty($fonte)){ echo "Fonte : <strong>$fonte</strong>"; echo "<br><br>"; }
					...
					echo "<br><br>";
					echo "<span class=\"style14\">";					
					echo "<strong>".formataStamp($quando, "/", 0). ' - ' . formataStamp($quando, ":", 1)."</strong>";
					echo "<br>";
					echo "Por : <strong>". retornaAdmin($autor) ."</strong>";
					echo "</span>";
	?>
    </td>
  ...
  <tr>
    <td height="652"> <img src="images/spacer.gif" width="1" height="30" alt=""></td>
    <td></td>
  </tr>
  <tr>
