...
<table width="763" height="768" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
  ...
  <tr>
    ...
    <td colspan="6" rowspan="10" valign="top" bgcolor="eff6ee"><div align="center">
      <p class="style13"><br>
        <span class="style11"><img src="images/bolinha.gif" width="6" height="6"> </span>Alterar Not&iacute;cias </p>
	  <?php
	  	$id = $_GET['id'];
	  	if($id != 0){
			if(empty($id)){
		...
		$query = $MySQL->Query("SELECT * FROM {$tabela['noticias']} WHERE {$camposTab1[0]} = $id");
		...
		$quando     = $data['not_quando'];	  
	  ?>
      <form name="form_noti" method="post" action="alterar.php?tipo=noticia&id=<?= $id ?>">
        <table width="400" border="0">
          <!--DWLayoutTable-->
          <tr>
            <td width="142" class="style11"><div align="right"><img src="images/bolinha.gif" width="6" height="6"> Titulo </div></td>
            <td width="242"><input name="not_titulo" type="text" class="caixa" id="not_titulo" size="45" value="<?= $titulo ?>"></td>
            <td width="2"></td>
          </tr>
          <tr>
            <td class="style11"><div align="right"><img src="images/bolinha.gif" width="6" height="6"> Fonte </div></td>
            <td><input name="not_fonte" type="text" class="caixa" id="not_fonte" size="45" value="<?= $fonte ?>"></td>
            <td></td>
          </tr>
          <tr>
            <td class="style11"><div align="right"><img src="images/bolinha.gif" width="6" height="6"> Quando</div></td>
            <td class="style11">: <?= formataStamp($quando, "/", 0). ' - ' . formataStamp($quando, ":", 1) ?></td>
            <td></td>
          </tr>
          <tr>
          ...
          <tr>
            <td height="91" valign="top"><div align="right"><span class="style11"> <img src="images/bolinha.gif" width="6" height="6"> Not&iacute;cia </span></div></td>
            <td valign="top"><textarea name="not_descricao" cols="44" rows="7" class="caixa" id="not_descricao"><?= $descricao ?></textarea></td>
            <td></td>
          </tr>
          ...
          <tr>
            ...
            <td valign="top">
                ...
                <div align="center">
  <input name="Enviar" type="button" class="caixa" id="Enviar" value="Enviar" onClick="validaNoticia(document.form_noti.not_titulo, document.form_noti.not_descricao, document.form_noti)">
  &nbsp;</div></td>
            <td></td>
          </tr>
          <tr>
