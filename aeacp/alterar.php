  ...
  <tr>
      ...
      <?php
		...
		switch($tipo){
			case 'noticia':
				...
				$MySQL->Update($tabela['noticias'], "$idEle = {$camposTab1[0]}", $camposTab1, $ins);
			...
			case 'admin':
				...
				$MySQL->Update($tabela['admin'], "$idEle = {$camposTab2[0]}", $camposTab2, $ins);
			...
			case 'par':
				...
				$MySQL->Update($tabela['parceiro'],"$idEle = {$camposTab3[0]}", $camposTab3, $ins);
				
				$msg = "Site relacionado alterado com sucesso !!!";						
			break;
		}
	...
	?>
      <div align="center" class="style13">
        <p>&nbsp;</p>
        <p><img src="images/bolinha.gif" width="6" height="6"> Alterando
          <?= $titulo ?>
        </p>
      </div>
      <span class="style14">
