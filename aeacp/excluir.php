  ...
  <tr>
      ...
      <?php
		...
		switch($tipo){
			case 'noticia':
				...
				$MySQL->Deletar($tabela['noticias'], $camposTab1[0], $idEle);
			...
			case 'admin':
				...
				$MySQL->Deletar($tabela['admin'], $camposTab2[0], $idEle);
			...
			case 'par':
				...
				$MySQL->Deletar($tabela['parceiro'], $camposTab3[0], $idEle);
				
				$msg = "Site relacionado excluido com sucesso !!!";
	...
	?>
      <div align="center" class="style13">
        <p>&nbsp;</p>
        <p><img src="images/bolinha.gif" width="6" height="6"> Excluindo
          <?= $titulo ?>
        </p>
      </div>
      <span class="style14">
