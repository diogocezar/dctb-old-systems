    ...
    <td colspan="6" rowspan="10" valign="top" bgcolor="eff6ee"><div align="center">
      ...
      <form name="form1" method="post" action="">
        <table width="400" border="0">
          <tr>
            <td class="style11"><div align="right"><img src="images/bolinha.gif" width="6" height="6"> Titulo </div></td>
            <td><input name="textfield" type="text" class="caixa" size="45"></td>
          </tr>
          <tr>
            <td width="141" class="style11"><div align="right"><img src="images/bolinha.gif" width="6" height="6"> Fonte</div></td>
            <td width="243"><input name="textfield" type="text" class="caixa" size="45"></td>
          </tr>
          <tr>
            <td valign="top"><div align="right"><span class="style11"> <img src="images/bolinha.gif" width="6" height="6"> Not&iacute;cia </span></div></td>
            <td><textarea name="textarea" cols="44" rows="7" class="caixa"></textarea></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>
              <div align="left">
                <input name="Submit" type="submit" class="caixa" value="Alterar">
              </div></td>
          </tr>
        </table>
      </form>
