  ...
  <tr>
    <td colspan="3" rowspan="10" valign="top" bgcolor="#FFFFFF"><br>
      <table width="95%" border="0" align="center">
        <tr>
          <td><span class="style14"><img src="images/bolinha.gif" width="6" height="6"> Voc&ecirc; est&aacute; logado como</span><span class="style11"> Fulano </span></td>
        </tr>
      </table></td>
    ...
    <td colspan="6" rowspan="10" valign="top" bgcolor="eff6ee"><div align="center">
      ...
      <table width="450" border="0" bordercolor="#4C7149">
        <tr bgcolor="#FFFFFF">
          <td colspan="3" bordercolor="#40683D"><font color="40683d" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong><img src="images/bolinha.gif" width="6" height="6"> Estudo do Greenpeace aponta que grandes empresas europ&eacute;ias rejeitam alimentos transg&ecirc;nicos</strong></font></td>
          </tr>
        <tr>
          <td width="312" bordercolor="#40683D">&nbsp;</td>
          <td width="63" class="style11"><font color="40683d" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong><img src="images/bolinha.gif" width="6" height="6"> </strong></font><a href="#">Excluir</a></td>
          <td width="61" class="style11"><font color="40683d" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong><img src="images/bolinha.gif" width="6" height="6"> </strong></font><a href="#">Alterar</a></td>
        </tr>
      </table>
      <p class="style13"></p>
      <table width="450" border="0" bordercolor="#4C7149">
