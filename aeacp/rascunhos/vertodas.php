...
<table width="763" height="768" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
  ...
  <tr>
    <td height="24" colspan="3" valign="top"><img src="images/top_ultimasnoticias.gif" width="203" height="24"></td>
    <td colspan="8" valign="top"><img src="images/top_noticiasanterioresgrd.gif" width="534" height="24"></td>
  ...
  <tr>
    <td colspan="3" rowspan="10" valign="top" bgcolor="#FFFFFF"><br>
      <table width="90%" border="0" align="center">
        <tr>
          <td><p><font color="#336633" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Abertas inscri&ccedil;&otilde;es para Semin&aacute;rio sobre Agroecologia </strong><br>
        Est&atilde;o abertas as inscri&ccedil;&otilde;es para participa&ccedil;&atilde;o no 6&ordm; Semin&aacute;rio Internacional sobre Agroecologia e 7&ordm; Semin&aacute;rio Estadual sobre Agroecologia, marcados para o per&iacute;odo de 16 a 18 de novembro, no audit&oacute;rio da Assembl&eacute;ia Legislativa, em Porto Alegre...</font></p>
              <p align="right"><font color="#336633" size="1" face="Verdana, Arial, Helvetica, sans-serif"><img src="images/bolinha.gif" width="6" height="6"> <strong><a href="#">Veja mais</a></strong> </font></p>
              <p align="left"><font color="#336633" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Pa&iacute;ses Ibero-Americanos v&atilde;o implementar rastreabilidade </strong><br>
        Representantes dos pa&iacute;ses que participaram na Espanha da XIII Confer&ecirc;ncia Ibero-Americana de Agricultura se comprometeram a implementar sistemas de rastreabilidade exigidos pela Europa nas importa&ccedil;&otilde;es de produtos aliment&iacute;cios, incluindo...</font></p>
              <p align="right"><font color="#336633" size="1" face="Verdana, Arial, Helvetica, sans-serif"><img src="images/bolinha.gif" width="6" height="6"> <strong><a href="#">Veja mais</a></strong></font><font color="#336633" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong><br>
              </strong></font></p>
          </td>
        </tr>
      </table></td>
    ...
    <td colspan="6" rowspan="10" valign="top" bgcolor="eff6ee"><div align="center">
      ...
      <table width="450" border="0" bordercolor="#4C7149">
        <tr bgcolor="#FFFFFF">
          <td bordercolor="#40683D"><font color="40683d" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong><img src="images/bolinha.gif" width="6" height="6"> Estudo do Greenpeace aponta que grandes empresas europ&eacute;ias rejeitam alimentos transg&ecirc;nicos</strong></font></td>
        </tr>
        <tr>
          <td bordercolor="#40683D"><font color="40683d" size="1" face="Verdana, Arial, Helvetica, sans-serif">Um estudo elaborado pelo Greenpeace Internacional mostra que 90% dos maiores varejistas e 73% dos grandes fabricantes de alimentos e bebidas da Uni&atilde;o Europ&eacute;ia adotaram uma pol&iacute;tica de n&atilde;o utiliza&ccedil;&atilde;o de transg&ecirc;nicos em seus neg&oacute;cios no mercado europeu para atender &agrave; nova legisla&ccedil;&atilde;o europ&eacute;ia de rotulagem.</font><font color="40683d" size="1" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;</font></td>
        </tr>
        <tr>
          <td bordercolor="#40683D"><div align="right"><font color="40683d" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>&nbsp;<img src="images/bolinha.gif" width="6" height="6">&nbsp; <a href="#">Leia Mais</a></strong></font></div></td>
          </tr>
      </table>
      <br>
      <table width="450" border="0" bordercolor="#4C7149">
      ...
      <table width="250" border="0">
        <tr align="center" class="style11">
          <td colspan="4">P&aacute;gina <span class="style15">2</span> de <span class="style15">15</span> </td>
          </tr>
        <tr align="center" class="style11">
          <td><a href="#">Primeria</a></td>
          <td><a href="#">Anterior</a></td>
          <td><a href="#">Proxima</a></td>
