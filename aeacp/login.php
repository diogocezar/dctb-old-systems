...
<?php
	...
	/*
	 *
	 * Se o usuário já se logou anteriormente, o script redireciona para a pag de administração.
	 *
	 */
	 if($_GET['sair'] == "sim"){
	 	$Session->DeletaSession('permitido');
		$Session->DeletaSession('id');
		$Session->DeletaSession('login');
	 }

	if($Session->VeriSession('permitido', 'OK') == OK){
		if($Session->ExisteSession('login') == OK){
  ...
  <tr>
    <td colspan="3" rowspan="10" valign="top" bgcolor="#FFFFFF"><br>
      <table width="95%" border="0" align="center">
        <tr>
          <td><form name="form_log" method="post" action="admin.php">
            <div align="center">                <span class="style11"><img src="images/bolinha.gif" width="6" height="6"> Login<span class="style12">|</span> </span>                
                <input name="log_login" type="text" class="caixa" id="log_login">
                <span class="style11"><br>
                <br>
                <img src="images/bolinha.gif" width="6" height="6"> Senha</span>
                <input name="log_senha" type="password" class="caixa" id="log_senha">
                <br>
                <br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input name="Submit" type="submit" class="caixa" value="Entrar" onClick="validaLogin(document.form_log.log_login, document.form_log.log_senha, document.form_log)">
              </div>
          </form>
		  </td>
        </tr>
    ...
    <td colspan="6" rowspan="10" valign="top" bgcolor="eff6ee"><div align="center"><br>      
        </div></td>
