...
<table width="763" height="768" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
  ...
  <tr>
    ...
    <td colspan="6" rowspan="10" valign="top" bgcolor="eff6ee"><div align="center">
      <p class="style13"><br>
        <span class="style11"><img src="images/bolinha.gif" width="6" height="6"> </span>        Administrar Sites Realacionados </p>
		<?php
							$Util = new Util;
							...
							define(ASSUNTO, 'sites relacionados'); ## ALTERAR (DINÂMICO) ##
							define(TABELA, $tabela['parceiro']); ## ALTERAR (DINÂMICO) ##
							...
							define(ATUAL, $start);
							define(POR_PAGINA, PP_ADM_PAR);
							define(TOTAL, ceil((QTD)/POR_PAGINA));
							define(ORDENADO, 'par_id'); ## ALTERAR (DINÂMICO) ##
							...
							while($data = mysql_fetch_array($query)){## ALTERAR (DINÂMICO) ##
								...
								$id        = $data[$camposTab3[0]]; 
								$link      = $data[$camposTab3[1]];
								$descricao = $data[$camposTab3[2]];
								echo "
								<table width=\"450\" border=\"0\" bordercolor=\"#4C7149\">
									<tr bgcolor=\"#FFFFFF\">
									  <td colspan=\"3\" bordercolor=\"#40683D\"><font color=\"40683d\" size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\"><strong><img src=\"images/bolinha.gif\" width=\"6\" height=\"6\"> $link</strong></font></td>
									  </tr>
									<tr>
									  <td width=\"312\" bordercolor=\"#40683D\">&nbsp;</td>
									  <td width=\"63\" class=\"style11\"><font color=\"40683d\" size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\"><strong><img src=\"images/bolinha.gif\" width=\"6\" height=\"6\"> </strong></font><a href=\"excluir.php?tipo=par&id=$id\">Excluir</a></td>
									  <td width=\"61\" class=\"style11\"><font color=\"40683d\" size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\"><strong><img src=\"images/bolinha.gif\" width=\"6\" height=\"6\"> </strong></font><a href=\"frm_alterar_par.php?id=$id\">Alterar</a></td>
									</tr>
								  </table>";
							}
