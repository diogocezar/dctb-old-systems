...
<table width="763" height="768" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
  ...
  <tr>
    ...
    <td colspan="6" rowspan="10" valign="top" bgcolor="eff6ee"><div align="center">
      <p class="style13"><br>
        <span class="style11"><img src="images/bolinha.gif" width="6" height="6"> </span>        Inserir Sites Realacionados </p>
      <form name="form_parc" method="post" action="adicionar.php?tipo=par">
        <table width="400" border="0">
          <!--DWLayoutTable-->
          
          <tr>
            <td width="142" class="style11"><div align="right"><img src="images/bolinha.gif" width="6" height="6"> Link </div></td>
            <td width="242"><input name="par_link" type="text" class="caixa" id="par_link" size="45"></td>
            <td width="2"></td>
          </tr>
          <tr>
            <td height="91" valign="top"><div align="right"><span class="style11"> <img src="images/bolinha.gif" width="6" height="6"> Descri&ccedil;&atilde;o </span></div></td>
            <td valign="top"><textarea name="par_descricao" cols="44" rows="7" class="caixa" id="par_descricao"></textarea></td>
            <td></td>
          </tr>
