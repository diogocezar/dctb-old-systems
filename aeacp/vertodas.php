...
<table width="763" height="768" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
  ...
  <tr>
      ...
      <table width="90%" border="0" align="center">
        <tr>
		  ...
		  <?
			...
			$query = $MySQL->Query("SELECT * FROM {$tabela['noticias']} ORDER BY {$camposTab1[0]} DESC LIMIT 2");
			while($data = mysql_fetch_array($query)){
				...
				echo "$descricao";
				echo "</span>";			
				echo "<p align=\"right\"><font color=\"#336633\" size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\"><img src=\"images/bolinha.gif\" width=\"6\" height=\"6\"> <strong><a href=\"vernoticia.php?id=$id\">Veja mais</a></strong> </font></p>";
    ...
    <td colspan="6" rowspan="10" valign="top" bgcolor="eff6ee">
	<div align="center">
	<?php
	$Util = new Util;
						
	define(ASSUNTO, 'notícias'); ## ALTERAR (DINÂMICO) ##
	define(TABELA, $tabela['noticias']); ## ALTERAR (DINÂMICO) ##
	define(ORDEM, 'DESC'); ## ALTERAR (DINÂMICO) ##
	...
	define(ORDENADO, 'not_id'); ## ALTERAR (DINÂMICO) ##
	define(SQL, "SELECT * FROM ".TABELA." ORDER BY ".ORDENADO." ".ORDEM." LIMIT ".ATUAL.", ".POR_PAGINA);
	
	$query = $MySQL->Query(SQL);
	echo "<br>";
	while($data = mysql_fetch_array($query)){## ALTERAR (DINÂMICO) ##
		...
		<table width=\"450\" border=\"0\" bordercolor=\"#4C7149\">
				<tr bgcolor=\"#FFFFFF\">
				  <td bordercolor=\"#40683D\"><font color=\"40683d\" size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\"><strong><img src=\"images/bolinha.gif\" width=\"6\" height=\"6\"> $titulo </strong></font></td>
				</tr>
				<tr>
				  <td bordercolor=\"#40683D\"><font color=\"40683d\" size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\">
				  $descricao
				  </font><font color=\"40683d\" size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\">&nbsp;</font></td>
				</tr>
				<tr>
				  <td bordercolor=\"#40683D\"><div align=\"right\"><font color=\"40683d\" size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\"><strong>&nbsp;<img src=\"images/bolinha.gif\" width=\"6\" height=\"6\">&nbsp; <a href=\"vernoticia.php?id=$id\">Leia Mais</a></strong></font></div></td>
				  </tr>
			  </table>";
	}
	...
	/* Controle da Paginação */
		...
		echo "Exibindo página : <b>$agora</b> de <b>$todas</b> páginas<br>";
		echo "Existem <b>".QTD."</b> de ".ASSUNTO." em nosso site.<br>";
		echo "Exibindo <b>".POR_PAGINA."</b> ".ASSUNTO." por página.<br><br>";
		echo "</span>";
	?>
    </div></td>
