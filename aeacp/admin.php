...
<?php
 ...
 if(!empty($login) && !empty($senha)){
	 ...
	 $query = $MySQL->Query("SELECT * FROM {$tabela['admin']}");
	 
	 while($data = mysql_fetch_array($query)){
		if($data['adm_login'] == $login && $data['adm_senha'] == $senha){
			$nome = $data['adm_nome'];
			$login = $data['adm_login'];
			$ident = 'Id#'.$data['adm_id'];
			$Session->GravaSession('permitido', 'OK');
			$Session->GravaSession('login'    , $login);		
			$Session->GravaSession('id'       , $ident);
			$permitido = true;
		}
	 } 
 }
...
<table width="763" height="768" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
  ...
  <tr>
    ...
    <td colspan="6" rowspan="10" valign="top" bgcolor="eff6ee"><div align="center">
      <p><br>      
        <br>      
        <span class="style13"><img src="images/bolinha.gif" width="6" height="6"> <strong><a href="frm_inserir.php">Inserir Not&iacute;cia</a><br>
          <br>
          <img src="images/bolinha.gif" width="6" height="6"> <strong><a href="alterartodas.php">Alterar Not&iacute;cias<br>
          <br>
          </a><img src="images/bolinha.gif" width="6" height="6"> <strong><a href="frm_inserir_par.php">Inserir <span class="style15">Sites Realacionados</span><br>
          <br>
          </a><strong><strong><strong><img src="images/bolinha.gif" width="6" height="6"> </strong><a href="alterartodas_par.php">Alterar <span class="style15">Sites Realacionados </span><br>
          </a></strong></strong></strong></strong></strong></span><span class="style13"><strong><strong><br>
        <img src="images/bolinha.gif" width="6" height="6"> <strong><a href="frm_ins_adm.php">Gerenciar Administradores<br>
        <br>
        </a><strong><img src="images/bolinha.gif" width="6" height="6"> <strong><a href="login.php?sair=sim">Sair</a></strong></strong><a href="frm_ins_adm.php"><br>
        <br>
