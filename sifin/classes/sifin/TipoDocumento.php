...
class TipoDocumento extends Generic{
	...
	*/
	...
	/**
	* Construtor
	* __construct_TipoDocumento()
	*/
	public function __construct_TipoDocumento(){}	
	...
	*/  
    public function __toFillGeneric(){
		...
		$condicao = $camposMap['tipodocumento'][0]." = ".$cod;
		...
		$this->setTabela($tabelaMap['tipodocumento'], true);
		$this->setCampos($camposMap['tipodocumento'], true);        
