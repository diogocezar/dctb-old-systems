	...
	if ( $_SESSION['nivel'] == 1 ){
		...
		if ( $sqlClone != $sql ){
			...
			if ( conectNumberLines( &$sql ) == 0 ){
				...
				header ( "Location: ".$pagina."regra/consultarUsuarioRetorno.php" );
			}
		} else {
			retorna( $pagina."regra/consultarUsuario.php" , " PREENCHER ALGUM CAMPO PARA EFETUAR A PESQUISA!", NULL, NULL );
		}
		/*FIM CONSULTAR DADOS*/
	} else {
