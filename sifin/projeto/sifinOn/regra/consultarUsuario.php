...
?>
	<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			...
			?>
			<form name="consultarUsuario" method="post" action="consultarUsuarios.php">
				<div id="pageServ">
					<div id="pageAlin">
						Nome:
						<input name="nome" id="nome" type="text" maxlength="100" size="100">
					</div>
					<div id="pageAlin">
						Login:<br>
						<input name="login" id="login" type="text" maxlength="30" size="20">
					</div>
					<div id="pageAlin">
					...
					<div align="center">
						...
						<input name="Limpar" type="reset" value="Limpar" onClick="document.consultarUsuario.nome.focus();">
					</div>
				</div>
			</form>
			<?
			...
			?>
			document.consultarUsuario.<? print $foco;?>.focus();
			</script>
		</body>
	</html>
<?
