	...
	<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<?
				...
				if ( $_GET['cadastro'] != NULL ){
					print '<div id="pageAlin"><font color="#0000FF">USU&Aacute;RIO CADASTRADO COM SUCESSO!</font></div>';
				}
			?>
			<form name="cadastrarUsuario" method="post" action="cadastrarUsuarios.php">
				<div id="pageServ">
					<div id="pageAlin">
						Nome:
					...
					<div id="pageAlin">
						Senha:<br>
						<input name="senha" id="senha" type="password" maxlength="50" size="20" value="<? print $_GET['senha']; ?>">
					</div>
					<div id="pageAlin">
					...
					<div align="center">
						...
						<input name="Limpar" type="reset" value="Limpar" onClick="document.cadastrarUsuario.nome.focus();">
					</div>
				</div>
			</form>
			<?
			...
			?>
			document.cadastrarUsuario.<? print $foco;?>.focus();
			</script>
		</body>
	</html>
<?
