...
?>
	<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			...
			?>
			<form name="excluirUsuario" method="post" action="excluirUsuarios.php">
				<div id="pageServ">
					<div id="pageAlin">
						Nome:
					...
					<div align="center">
						...
						<input name="Limpar" type="reset" value="Limpar" onClick="document.excluirUsuario.nome.focus();">
					</div>
				</div>
			</form>
			<?
			...
			?>
			document.excluirUsuario.<? print $foco;?>.focus();
			</script>
		</body>
	</html>
<?
