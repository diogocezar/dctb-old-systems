...
function infValEvento(data, hora, local, descricao, form){
	var erro = false;
	...
	if(hora.value == ""){
		alert(retornaString('hora'));
		setaFoco(hora);
		erro = true;
	}
	if(local.value == ""){
		alert(retornaString('local'));
		setaFoco(local);
		erro = true;
	}
	if(descricao.value == ""){
...
function infValDisc(nome, periodo, cargaHoraria, objetivos, ementas, form){
	var erro = false;
	...
	if(periodo.value == ""){
		alert(retornaString('período'));
		setaFoco(periodo);
		erro = true;
	}
	if(cargaHoraria.value == ""){
		alert(retornaString('carga horária'));
		setaFoco(cargaHoraria);
		erro = true;
	}
	if(objetivos.value == ""){
...
function infValAdmin(nome, login, senha, email, form){
	var erro = false;
...
function infValNoticia(titulo, form){
	var erro = false;
...
function infValLink(nome, url, descricao, form){
	var erro = false;
...
function infValProf(nome, nick, site, descricao, email, form){
	var erro = false;
...
function infValLogin(login, senha, form){
	var erro = false;
...
/*
 * Mascara de hora
 * Gécen, Ex. de como usar: onkeypress="formatHora(this,event)"
 */
