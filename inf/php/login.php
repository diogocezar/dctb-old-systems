...
$template->setCurrentBlock("bloco_login");	
	...
	$template->setVariable("titulo", "Entre com seu login e senha");
	$template->setVariable("onClickEnviar", "infValLogin(document.form_login.login, document.form_login.senha, document.form_login)");
