...
* Origem do email.
*/
define(ORIGEM, 'falecom@promotos.com.br');
...
* Mensagem final.
*/
define(MSG_FINAL, 'Caso deseje responder este e-mail utilize o formulário de contatos do site da Promotos.<br><br>
