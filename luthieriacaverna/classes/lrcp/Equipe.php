...
class Equipe extends Generic{
	...
	* __construct_Equipe()
	*/
	public function __construct_Equipe(){}	
	...
	*/  
    public function __toFillGeneric(){
		...
		$condicao = $camposMap['equipe'][0]." = ".$cod;
		...
		$this->setTabela($tabelaMap['equipe'], true);
		$this->setCampos($camposMap['equipe'], true);        
	...
	*/  
	public function __get_db($key){
		...
		if(!DB::isError($resultado)){
			...
			$this->setApresentacao ($dados[$this->campos[3]]);
		}
	}//__get
