...
define(SQL, "SELECT fab_cod, fab_nome FROM ".TABELA." ORDER BY ".ORDENADO." ".ORDEM." LIMIT ".ATUAL.", ".POR_PAGINA);
...
while($dados = $resultado->fetchRow(DB_FETCHMODE_ASSOC)){
	...
	$template->setCurrentBlock("bloco_listar_interno");
		$largura = 272;
		$altura  = 325;
		$linha  = "<a href =\"busca.php?fabricante={$dados['fab_cod']}\" class=\"link_claro\">";
		$linha .= $dados['fab_nome'];
		$linha .= "</a>";
		$linha .= "</a>";
		$linha .= " - <a href=\"#\" onClick=\"abrir('detalhes.php?tipo=fabricante&id=".$dados['fab_cod']."', '".$largura."', '".$altura."', 'yes')\" class=\"link_claro\">Detalhes</a>";		
...
$template->setCurrentBlock("bloco_listar");
	...
	/* Titulos */
		$template->setVariable("tituloListar", "Listando os Fabricantes:");
