...
switch($tamanho){
	case 1  : $Photo = new Photo($localizacao, LARGURA_MINIATURA, ALTURA_MINIATURA, $scalar); break; 
	case 2  : $Photo = new Photo($localizacao, LARGURA_GRANDE   , ALTURA_GRANDE   , $scalar); break;
	default : 
