...
while($dados = $resultado->fetchRow(DB_FETCHMODE_ASSOC)){
	$template->setCurrentBlock("bloco_produtos_1");
		...
		$template->setVariable("img1",       "<a href =\"mostraProduto.php?id={$dados['pro_cod']}\"><img src=\"img.php?loc={$dados['fot_url']}&a=90&l=90\" border=\"0\"></a>");
...
while($dados = $resultado->fetchRow(DB_FETCHMODE_ASSOC)){
	$template->setCurrentBlock("bloco_produtos_2");
		...
		$template->setVariable("img2",       "<a href =\"mostraProduto.php?id={$dados['pro_cod']}\"><img src=\"img.php?loc={$dados['fot_url']}&a=90&l=90\" border=\"0\"></a>");
