 ...
 * Framework phpmailer
 */
require_once("../core/components/phpmailer/class.phpmailer.php");
 ...
 */
require_once("../core/library/util.php");
require_once("../core/library/library.php");

/**
 * Envio de e-mail
 * E-mail sends
 */
//require_once("../core/components/mail/Mail.php");
//require_once("../core/components/mail_mime/mime.php");
...
class Brain{
	...
	function errorFunction($className){
		$function .= 'private function error($message){';
