...
abstract class XMLExports{
	...
	public static function conf(){
		...
		/* Site Info */
		$conf['info'] = array(
			'label'      => "Sistema de Gerenciamento de Cadastros da Pós-Graduação ".date(Y),
			'title'      => "SGCP",
			...
			'credits'    => "SGCP ".date('Y')." ~ <a href=\"http://www.diogocezar.com\" class=\"link-credits\">Diogo Cezar</a>"
		);
		...
		$conf['cookies'] = array(
			'expire' => '3600',
			'path_cookie' => '/',
			'domain' => 'http://www.cp.utfpr.edu.br/inscpos',
			'secure' => 0
		);
	...
	public static function label_mapping(){
		$label_mapping['administrador'] = array(
			'idadministrador' => 'identificação do administrador',
			'nome'            => 'nome',
			'login'           => 'login'
		);
		
		$label_mapping['curso'] = array(
			'idcurso'              => 'identificação do curso',
			'nome'                 => 'nome',
			'periodo_inscricao'    => 'período de inscrição'
		);
		
		$label_mapping['inscricao'] = array(
			'idinscricao'            => 'identificação da inscrição',
			'idcurso'                => 'identificação do curso',
			'nome'                   => 'nome do candidato',
			'data_nascimento'        => 'data de nascimento',
			'curso_graduacao'        => 'curso de graduação',
			'instituicao_graduacao'  => 'instituição de graduação',
