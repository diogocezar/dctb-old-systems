...
/* Capturando Pedido */
$templateHtmlName = 'formContatos.html';
...
$template->setCurrentBlock("bloco_contatos");
	...
	/* Botões */
		...
		$template->setVariable("linkRedefinir", "#");
		$template->setVariable("altRedefinir", "Redefinir !");
		
	/* Formulario */
		$template->setVariable("formContatos", "form_contato");
		$template->setVariable("actionContatos", "enviaContato.php");
	
	/* Titulos */
		$template->setVariable("tituloContato", "Contato");
		$template->setVariable("tituloEmail", "Email");
		$template->setVariable("tituloEndTel", "Outros");
	...
	/* Nomes dos Campos */
		...
		$template->setVariable("campoComentario", "comentario");
	
	/* Java Script ao Enviar */
		$template->setVariable("onClickEnviar", "validaContato(form_contato.nome, form_contato.email, form_contato.telefone, form_contato.cidade, form_contato.comentario, form_contato)");
		$template->setVariable("onClickRedefinir", "redefineContato(form_contato.nome, form_contato.email, form_contato.telefone, form_contato.cidade, form_contato.comentario)");
