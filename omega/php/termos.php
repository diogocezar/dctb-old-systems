...
/* Conversão das variáveis dos blocos */
	...
	$template->setCurrentBlock("bloco_termos");
	
			$template->setVariable("linkAceito", "aceito.php?genero=$genero");
			$template->setVariable("altAceito", "Aceito !");
			
			$template->setVariable("linkNaoAceito", "index.php");
			$template->setVariable("altNaoAceito", "Não Aceito !");
			
			$template->setVariable("tituloAvisoLegal", "Aviso legal :");

	$template->parseCurrentBlock("bloco_termos");

$show = $template->get();

/* Título da Página Interna */
$tituloInterna = "Aviso legal";
