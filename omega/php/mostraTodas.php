...
define(ATUAL, $start);
define(POR_PAGINA, PP_NOVIDADES_TODAS);
define(TOTAL, ceil((QTD)/POR_PAGINA));
define(SQL, "SELECT usu_cod, nov_titulo, nov_conteudo, nov_quando, nov_id FROM ".TABELA." ORDER BY ".ORDENADO." ".ORDEM." LIMIT ".ATUAL.", ".POR_PAGINA);
...
while($dados = $resultado->fetchRow(DB_FETCHMODE_ASSOC)){
	$template->setCurrentBlock("bloco_detalhes_item");
		...
		$descricao  = limpaQuebra(limitaStr($dados['nov_conteudo'], 160));
		$descricao .= "<br>";
		$descricao .= "<div align=\"right\">";
		$descricao .= "<a href = \"mostraNovidade.php?id={$dados['nov_id']}\"><img src=\"../images/bot_add.jpg\" border = \"0\" alt=\"Veja Mais !\"/></a><br>";
		$descricao .= $quando.' por <b>'.$usuario.'</b>';
		$descricao .= "</div>";
		$titulo     = limitaStr($dados['nov_titulo'], 80);
...
$tituloInterna = "Listando Todas Novidades";
