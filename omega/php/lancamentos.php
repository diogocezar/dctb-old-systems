...
$sqlCount = "SELECT count(distinct(fil.fil_titulo)) as qtd
			 ...
			 WHERE fil.cat_cod = cat.cat_cod AND cat.cat_nome = 'Lançamento' AND genf.gen_cod = gen.gen_cod AND fil.fil_cod = genf.fil_cod AND gen.gen_nome <> 'Pornô'
...
if($contem_resultado == false){
	$template->setCurrentBlock("bloco_gerenciar_erro");
			$template->setVariable("erro", "Não foi encontrado nenhum filme em '<b>Lançamentos</b>'.");
...
$tituloInterna = "Exibindo Todos os Filmes '<b>Lançamentos</b>'";
