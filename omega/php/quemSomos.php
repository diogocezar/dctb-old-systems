...
/* Capturando Pedido */
$templateHtmlName = 'detalhesHistorico.html';
...
$quemSomos = "<div align=\"justify\">Em 1997, nasceu a Locadora Omega, acreditando no potencial da cidade, apostou
			  em uma regi&atilde;o descentralizada, atendendo assim a principio um publico esquecido
			  pelas demais locadoras. A Locadora apresentou um crescimento sustentado,
			  com um atendimento diferenciado e sempre buscando satisfazer da melhor maneira
			  seus clientes. Acabamos conquistando tamb&eacute;m clientes de outras regi&otilde;es da cidade,
			  no final de 2005 sempre visando o crescimento e o melhor atendimento aos clientes mudou de endere&ccedil;o.
			  No inicio de 2006, inaugurando a primeira locadora virtual da cidade e regi&atilde;o.
			  Podendo assim de uma maneira mais eficiente abranger toda a cidade de Corn&eacute;lio Proc&oacute;pio.<br><br>
			<strong>Miss&atilde;o </strong>
			<div align=\"justify\">Fornecer entretenimento, sempre com o m&aacute;ximo de conforto e comodidade
			  possivel. Buscando inova&ccedil;&otilde;es que possam antecipar os desejos e necessidades
			  de nossos clientes.<br><br>
			</div>
			<strong>Objetivo</strong>
			<div align=\"justify\">Construir a marca Locadora Omega, como refer&ecirc;ncia, atrav&eacute;s de um crescimento
			  sustentado da empresa.
			</div>
			<br><br>
			<div align=\"center\"><img src=\"img.php?l=380&a=300&s=n&loc=../images/locadora.jpg\" border = \"0\"></div>";

$template->setCurrentBlock("bloco_historico");
		...
		$template->setVariable("tituloHistorico",  "Quem somos ?");
		$template->setVariable("conteudo", $quemSomos);

$template->parseCurrentBlock("bloco_historico");

$show  = $template->get();
$show .= "<br>";

/* Título da Página Interna */
$tituloInterna = "Histórico";
