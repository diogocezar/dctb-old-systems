...
*/
define(BASE, 'locadoraomega');

/**
* Servidor do Banco de Dados.
*/
define(HOST, 'mysql.uni5.net');

/**
* Usuário do Banco de Dados.
*/
define(USER, 'locadoraomega');
...
* Origem do email.
*/
define(ORIGEM, 'no-reply@locadoraomega.com.br');

/**
* Empresa/Autor do email.
*/
define(AUTOR, 'Locadora Omega');

/**
* Mensagem final.
*/
define(MSG_FINAL, 'Caso deseje responder este e-mail utilize o formulário de contatos do site da Locadora Omega.<br><br>

Mensagens enviadas para esse e-mail, não serão verificadas.<br><br>

Este e-mail está sendo enviado porque é um usuário registrado da Locadora Omega. Ou também porque participou de alguma promoção ou foi indicado por algum conhecido. E de acordo com o novo Código de Ética AntiSPAM elaborado pela Brasil AntiSPAM e do "Guia de Boas Maneiras" para e-mail marketing da ABEMD - Associação Brasileira de Marketing Direto.<br><br>

Caso não queira continuar recebendo as mensagens da Locadora Omega ou estiver recebendo esta mensagem por engano, pedimos a gentileza de clicar aqui e você será automaticamente removido da nossa lista de relacionamento.<br><br>
...
* Domain.
*/
define(DOMAIN, 'http://kakitus.com/');
