...
function ecoValTipoEcoturismo(nome, form){
	var erro = false;
	if(nome.value == ""){
...
function ecoValTipoAtividade(nome, form){
	var erro = false;
	if(nome.value == ""){
		alert(retornaString('nome'));
		setaFoco(nome);
...
function ecoValAtividade(nome, descricao, localizacao, acesso, fotos, form){
	var erro = false;
	if(nome.value == ""){
		alert(retornaString('nome'));
		setaFoco(nome);
	...
	if(acesso.value == ""){
		alert(retornaString('acesso'));
		setaFoco(acesso);
		erro = true;
	}
	if(fotos.value == ""){
		alert(retornaString('fotos'));
		setaFoco(fotos);
		erro = true;
	}
	if(erro == false){
...
function ecoValEcoturismo(nome, descricao, localizacao, acesso, fotos, form){
	var erro = false;
	if(nome.value == ""){
		alert(retornaString('nome'));
		setaFoco(nome);
...
function ecoValCidade(nome, descricao, localizacao, acesso, fotos, lista1, lista2, form){
	var erro = false;
	if(nome.value == ""){
		alert(retornaString('nome'));
		setaFoco(nome);
...
function ecoValLogin(login, senha, form){
	var erro = false;
