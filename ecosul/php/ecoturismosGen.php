...
define(SQL, "SELECT idEcoturismo, nomeEcoturismo FROM ".TABELA." ORDER BY ".ORDENADO." ".ORDEM." LIMIT ".ATUAL.", ".POR_PAGINA);
...
while($dados = $resultado->fetchRow(DB_FETCHMODE_ASSOC)){
	...
	$template->setCurrentBlock("bloco_gerenciar_interno");
		...
		/* Links da imagens dos Campos */
			$template->setVariable("linkEditar", "ecoturismo.php?acao=atualizar&id={$dados['idEcoturismo']}");
			$template->setVariable("linkExcluir", "exclui.php?tipo=ecoturismo&id={$dados['idEcoturismo']}");
		
		/* Linha a ser impressa */
			$linha = limitaStr($dados['nomeEcoturismo'], LIMITE_GENRENCIAR);
