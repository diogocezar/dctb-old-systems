...
class Tree{
	...
	* @return String
	*/  
	public function geraLink($nome, $link){
	...
	* @return String
	*/	
	public function geraArvore($query, $tipo){
		global $nivel;
	...
	* @param String $link
	*/	
	public function createPage($name, $link){
	...
	*/	
	public function addMenu($nome, $feed, $ordem){
