...
class Cookie{
	...
	* @return void
	*/
	public function __go_Cookie($cookies){
	...
	* @return String
	*/
	public function retornaCookie($indice){
		global $erro; // Reconhecendo variavel global para os erros.
		if(!empty($indice)){
	...
	* @return void
	*/
	public function salvaCookie($indice, $valor){
		global $erro; // Reconhecendo variavel global para os erros.
		if(empty($indice) || empty($valor)){
	...
	* @return void
	*/
	public function deletaCookie($indice){
		unset($_COOKIE[$indice]);
	}//deletaCookie
}//Cookie
?>