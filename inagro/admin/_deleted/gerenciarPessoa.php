...
if(empty($tabela) || empty($campos)){
	echo "<script language=javascript>alert('Deve-se selecionar a tabela e seus campos para acionar o gerenciamento.');location.href='../admin/index.php'</script>";
	exit();
}
...
$template->setCurrentBlock("bloco_html");
	...
	$onLoad .= "onLoad = \"";
	$onLoad .= "call_getFiltredRegistersPessoa();";
	...
	$template->setVariable("cmp_form_key_up", "call_getFiltredRegistersPessoa()");
