...
$template->setCurrentBlock("bloco_formulario");
	...
	/* nomes dos campos */
		...
		$template->setVariable("campoQtdnumerico", "qtdnumerico");
		$template->setVariable("campoTipoperiodo", "tipoperiodo");
		$template->setVariable("campoSituacao",    "situacao");

	/* valores dos campos */
		$template->setVariable("valorDescricao",   $objRec->getDescricao());
		$template->setVariable("valorQtdnumerico", $objRec->getQtdnumerico());
		$template->setVariable("valorTipoperiodo", $objRec->getQtdtipoperiodo());
	...
	/* java script ao enviar */
		$template->setVariable("onClickEnviar", "sifinValPeriodicidade($form.descricao, $form.qtdnumerico, $form)");
