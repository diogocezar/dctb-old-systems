...
* SpeceBrain
*
* Esse neurônio é responsavel por gerar um arquivo XML nos padrões RSS
* This neuron is responsible to generate a XML file with RSS patterns
*
...
class RssGenerator{
	...
	*/  
	 function __go_RssGenerator($filePath){
